...
internal partial class Program
{
    ...
    private static readonly string[] ConfigKeys =
    {
        ...
        "new-session-dir-mode", "confirm-close-session", "hold-session-on-exit", "compact-toolbar", "toolbar-mode", "notification-badges", "workspace-add-button",
    ...
    private static string ConfigValue(string key) => key switch
    {
        ...
        "hold-session-on-exit" => _config.HoldSessionOnExit ? "true" : "false",
