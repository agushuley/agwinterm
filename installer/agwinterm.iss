...
#define AppVersion "0.20.10-ah.1"
; VersionInfoVersion: fourth field = -ah incremental (here 1). VersionInfoTextVersion shows the full AppVersion.
#define VersionInfoVersion "0.20.10.1"
